...
public class QuestionInit {
    ...
    public QuestionInit(LocationInit locationInit) {
        ...
        Question question5 = new Question(5, "Помогу решить вопрос с " + locationInit.getLocationById(2).getName(), Question.Type.CONTINUE);
        ...
        Question question11 = new Question(11, "Разрулю вопрос с " + locationInit.getLocationById(5).getName(), Question.Type.CONTINUE);
        ...
        Question question17 = new Question(17, "Договорюсь по " + locationInit.getLocationById(6).getName(), Question.Type.CONTINUE);
        ...
        Question question23 = new Question(23, "Помогу решить вопрос с " + locationInit.getLocationById(10).getName(), Question.Type.CONTINUE);
        ...
        Question question29 = new Question(29, "Помогу решить вопрос с " + locationInit.getLocationById(8).getName(), Question.Type.CONTINUE);
        ...
        Question question35 = new Question(35, "Помогу решить вопрос с " + locationInit.getLocationById(12).getName(), Question.Type.CONTINUE);
        ...
        Question question41 = new Question(41, "Помогу решить вопрос с " + locationInit.getLocationById(13).getName(), Question.Type.CONTINUE);
        ...
        Question question47 = new Question(47, "Помогу решить вопрос с " + locationInit.getLocationById(15).getName(), Question.Type.CONTINUE);
        ...
        Question question53 = new Question(53, "Помогу решить вопрос с " + locationInit.getLocationById(14).getName(), Question.Type.CONTINUE);
